...
class PixelEnemyWall {
    private Body body;

    PixelEnemyWall(float x, float y, World physicsWorld) {
        // set any pixel coordinates to world coordinates
        x  = x / PIXELS_TO_METERS * SCREEN_RATIO;
        y = y / PIXELS_TO_METERS * SCREEN_RATIO;
        float width  = (8 - .1f) / PIXELS_TO_METERS * SCREEN_RATIO;
        float height = (8 - .1f) / PIXELS_TO_METERS * SCREEN_RATIO;
        // create the platform
        ...
        fixtureDef.isSensor   = true;               // is a sensor
